export class SmsTextTemplateTexts {
    ...
    public static projectStartedTextGreeting: string = $localize`Thank you for choosing me for your project.` + "\n" + $localize`Work on your project has started. You can check the project status at this url: `;
    ...
    public static projectStartedTextFooter: string =  $localize`If you have any questions, then feel free to contact me` + "\n" + $localize`Kind regards, `;
    ...
    public static projectFinishedFooter: string =  $localize`For more information please refer to our other emails or documentation.` + "\n" + $localize`Kind regards, `;
